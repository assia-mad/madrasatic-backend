...
from .permissions import IsAuthenticated, DeclarationUserWritePermission


class DeclarationList(generics.ListCreateAPIView):
    permission_classes = [IsAuthenticated]
    queryset = Declaration.declarationpobjects.all()
...
class SavedDeclarationList(generics.ListAPIView, DeclarationUserWritePermission):
    ...
    queryset = Declaration.declarationbobjects.all()
    serializer_class = DeclarationSerializer
